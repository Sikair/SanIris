package data.missions.sanirisstationbattle;
...
//		addShip("warthog_wing", 5);
		...
		// Set up the fleets
		generateFleet(125 + (int)((float) Math.random() * 200), FleetSide.PLAYER, ships, api);
        api.addToFleet(FleetSide.ENEMY, "sikr_station3_standard", FleetMemberType.SHIP, false);
